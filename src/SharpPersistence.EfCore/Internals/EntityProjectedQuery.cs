...
/// Exists as a separate type because EF's <c>EnableTracking</c>/<c>AsNoTracking</c> only accept class
...
{
    public EntityProjectedQuery(IQueryable<T> query) : base(query)
    {
    }
    ...
    /// </summary>
    public override IEntityQuery<T> EnableTracking() => this;
